# MiniMax OAuth (ForgeOrchestrator plugin)
...
```bash
forge-orchestrator plugins enable minimax-portal-auth
```
...
```bash
forge-orchestrator models auth login --provider minimax-portal --set-default
```
