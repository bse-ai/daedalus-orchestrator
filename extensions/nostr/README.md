...
Nostr DM channel plugin for ForgeOrchestrator using NIP-04 encrypted direct messages.

## Overview

This extension adds Nostr as a messaging channel to ForgeOrchestrator. It enables your bot to:
...
# Configure forge-orchestrator to use local relay
