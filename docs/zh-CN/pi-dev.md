...
本指南总结了在 ForgeOrchestrator 中开发 Pi 集成的合理工作流程。
...
状态存储在 ForgeOrchestrator 状态目录下。默认为 `~/.forge-orchestrator`。如果设置了 `FORGE_ORCH_STATE_DIR`，则使用该目录。

要重置所有内容：

- `forge-orchestrator.json` 用于配置
...
- https://docs.forge-orchestrator.ai/testing
- https://docs.forge-orchestrator.ai/start/getting-started
