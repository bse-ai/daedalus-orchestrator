...
- 生成的 Swift 模型：`apps/macos/Sources/ForgeOrchestratorProtocol/GatewayModels.swift`
...
- https://raw.githubusercontent.com/forge-orchestrator/forge-orchestrator/main/dist/protocol.schema.json
