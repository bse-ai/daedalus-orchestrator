...
ForgeOrchestrator has two separate “streaming” layers:
...
When draft streaming is active, ForgeOrchestrator disables block streaming for that reply to avoid double-streaming.
