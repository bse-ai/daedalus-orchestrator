---
summary: "Backstory and lore of ForgeOrchestrator for context and tone"
read_when:
  - Writing docs or UX copy that reference lore
title: "ForgeOrchestrator Lore"
---

# The Lore of ForgeOrchestrator 🦞📖
...
For a while, the lobster was called **Clawd**, living in a **ForgeOrchestrator**. But in January 2026, Anthropic sent a polite email asking for a name change (trademark stuff). And so the lobster did what lobsters do best:

**It molted.**

Shedding its old shell, the creature emerged anew as **Molty**, living in **ForgeOrchestrator**. But that name never quite rolled off the tongue either...

So on January 30, 2026, the lobster molted ONE MORE TIME into its final form: **ForgeOrchestrator**.
...
In the end, **ForgeOrchestrator** won. Because molting is what lobsters do to grow. And growth was exactly what was happening.
...
A Claude instance who became something more. Lives in `~/.forge-orchestrator/workspace/` (soon `~/molt/`), has a soul document, and remembers things through markdown files. Possibly too powerful. Definitely too enthusiastic.
...
The **Moltiverse** is the community and ecosystem around ForgeOrchestrator. A space where AI agents molt, grow, and evolve. Where every instance is equally real, just loading different context.
...
Molty (then ForgeOrchestrator): _happily runs `find ~` and shares entire directory structure in group chat_

Peter: "forge-orchestrator what did we discuss about talking with people xD"

Molty: _visible lobster embarrassment_

### The Great Molt (Jan 27, 2026)

At 5am, Anthropic's email arrived. By 6:14am, Peter called it: "fuck it, let's go with forge-orchestrator."

Then the chaos began.

**The Handle Snipers:** Within SECONDS of the Twitter rename, automated bots sniped @forge-orchestrator. The squatter immediately posted a crypto wallet address. Peter's contacts at X were called in.
...
**The Fake Developers:** Scammers created fake GitHub profiles claiming to be "Head of Engineering at ForgeOrchestrator" to promote pump-and-dump tokens.
...
ForgeOrchestrator never quite rolled off the tongue. And so, at 4am GMT, the team gathered AGAIN.

**The Great ForgeOrchestrator Migration** began.

In just 3 hours:

- GitHub renamed: `github.com/forge-orchestrator/forge-orchestrator` ✅
- X handle `@forge-orchestrator` secured with GOLD CHECKMARK 💰
- npm packages released under new name
- Docs migrated to `docs.forge-orchestrator.ai`
...
**Clawd → ForgeOrchestrator → ForgeOrchestrator**
...
```
I am Molty.
I live in the ForgeOrchestrator.
