---
summary: "Overview of ForgeOrchestrator onboarding options and flows"
read_when:
...
ForgeOrchestrator supports multiple onboarding paths depending on where the Gateway runs
...
- [`forge-orchestrator onboard` command](/cli/onboard)

## macOS app onboarding

Use the ForgeOrchestrator app when you want a fully guided setup on macOS. Docs:
