---
summary: "Use MiniMax M2.1 in ForgeOrchestrator"
read_when:
...
- Use `forge-orchestrator models list` and `forge-orchestrator models set minimax/MiniMax-M2.1` to switch.
...
- Running `forge-orchestrator configure` and selecting **MiniMax M2.1**, or
