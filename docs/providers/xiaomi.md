---
summary: "Use Xiaomi MiMo (mimo-v2-flash) with ForgeOrchestrator"
read_when:
  - You want Xiaomi MiMo models in ForgeOrchestrator
...
the [Xiaomi MiMo console](https://platform.xiaomimimo.com/#/console/api-keys). ForgeOrchestrator uses
