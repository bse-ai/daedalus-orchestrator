---
summary: "Use Qwen OAuth (free tier) in ForgeOrchestrator"
read_when:
  - You want to use Qwen with ForgeOrchestrator
...
If you already logged in with the Qwen Code CLI, ForgeOrchestrator will sync credentials
