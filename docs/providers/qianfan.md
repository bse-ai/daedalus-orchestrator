---
summary: "Use Qianfan's unified API to access many models in ForgeOrchestrator"
read_when:
...
3. ForgeOrchestrator installed on your system
...
4. Copy the API key for use with ForgeOrchestrator

## CLI setup

```bash
forge-orchestrator onboard --auth-choice qianfan-api-key
```

## Related Documentation

- [ForgeOrchestrator Configuration](/gateway/configuration)
