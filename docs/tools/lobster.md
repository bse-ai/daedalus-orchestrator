...
Install the Lobster CLI on the **same host** that runs the ForgeOrchestrator Gateway (see the [Lobster repo](https://github.com/forge-orchestrator/lobster)), and ensure `lobster` is on `PATH`.
