...
export function collectHooksHardeningFindings(cfg: ForgeOrchestratorConfig): SecurityAuditFinding[] {
  const findings: SecurityAuditFinding[] = [];
...
export function collectSandboxDockerNoopFindings(cfg: ForgeOrchestratorConfig): SecurityAuditFinding[] {
  const findings: SecurityAuditFinding[] = [];
...
export function collectNodeDenyCommandPatternFindings(cfg: ForgeOrchestratorConfig): SecurityAuditFinding[] {
  const findings: SecurityAuditFinding[] = [];
