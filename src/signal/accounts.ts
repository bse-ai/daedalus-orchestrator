...
export function listSignalAccountIds(cfg: ForgeOrchestratorConfig): string[] {
...
export function resolveDefaultSignalAccountId(cfg: ForgeOrchestratorConfig): string {
