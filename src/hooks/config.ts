...
import type { ForgeOrchestratorConfig, HookConfig } from "../config/config.js";
...
export function resolveConfigPath(config: ForgeOrchestratorConfig | undefined, pathStr: string) {
...
export function isConfigPathTruthy(config: ForgeOrchestratorConfig | undefined, pathStr: string): boolean {
...
export function shouldIncludeHook(params: {
  ...
  const pluginManaged = entry.hook.source === "forge-orchestrator-plugin";
