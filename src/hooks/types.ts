...
export type ForgeOrchestratorHookMetadata = {
  always?: boolean;
  hookKey?: string;
  emoji?: string;
  homepage?: string;
...
export type Hook = {
  name: string;
  description: string;
  source: "forge-orchestrator-bundled" | "forge-orchestrator-managed" | "forge-orchestrator-workspace" | "forge-orchestrator-plugin";
  pluginId?: string;
...
export type HookEntry = {
  ...
  metadata?: ForgeOrchestratorHookMetadata;
