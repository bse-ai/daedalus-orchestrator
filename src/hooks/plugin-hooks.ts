...
import type { ForgeOrchestratorPluginApi } from "../plugins/types.js";
...
function resolveHookDir(api: ForgeOrchestratorPluginApi, dir: string): string {
...
function normalizePluginHookEntry(api: ForgeOrchestratorPluginApi, entry: HookEntry): HookEntry {
  return {
    ...entry,
    hook: {
      ...entry.hook,
