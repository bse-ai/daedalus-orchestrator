...
describe("update-startup", () => {
  ...
  beforeEach(async () => {
    ...
    tempDir = await fs.mkdtemp(path.join(os.tmpdir(), "forge-orchestrator-update-check-"));
  ...
  it("logs update hint for npm installs when newer tag exists", async () => {
    const { resolveForgeOrchestratorPackageRoot } = await import("./forge-orchestrator-root.js");
    ...
    vi.mocked(resolveForgeOrchestratorPackageRoot).mockResolvedValue("/opt/forge-orchestrator");
