...
describe("buildSandboxCreateArgs", () => {
  it("includes hardening and resource flags", () => {
    ...
    const args = buildSandboxCreateArgs({
      name: "forge-orchestrator-sbx-test",
      cfg,
      scopeKey: "main",
    ...
    expect(args).toEqual(
      expect.arrayContaining([
        "create",
        "--name",
        "forge-orchestrator-sbx-test",
        "--label",
        "forge-orchestrator.sandbox=1",
        "--label",
        "forge-orchestrator.sessionKey=main",
        "--label",
        "forge-orchestrator.createdAtMs=1700000000000",
        "--label",
        "forge-orchestrator.sandboxBrowser=1",
        "--read-only",
        "--tmpfs",
        "/tmp",
        "--network",
        ...
        "--security-opt",
        "apparmor=forge-orchestrator-sandbox",
        "--dns",
        "1.1.1.1",
        "--add-host",
  ...
  it("emits -v flags for custom binds", () => {
    ...
    const args = buildSandboxCreateArgs({
      name: "forge-orchestrator-sbx-binds",
      cfg,
      scopeKey: "main",
      createdAtMs: 1700000000000,
    });
  ...
  it("omits -v flags when binds is empty or undefined", () => {
    ...
    const args = buildSandboxCreateArgs({
      name: "forge-orchestrator-sbx-no-binds",
      cfg,
      scopeKey: "main",
      createdAtMs: 1700000000000,
    });
