...
export async function runEmbeddedAttempt(
  ...
  try {
    ...
    const toolsRaw = params.disableTools
      ? []
      : createForgeOrchestratorCodingTools({
          exec: {
    ...
    try {
      ...
      try {
        ...
        // double-compaction. See: https://github.com/forge-orchestrator/forge-orchestrator/issues/9282
      ...
      // See: https://github.com/forge-orchestrator/forge-orchestrator/issues/8643
      await flushPendingToolResultsAfterIdle({
        agent: session?.agent,
        sessionManager,
      });
