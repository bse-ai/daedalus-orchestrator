...
beforeAll(async () => {
  ...
  tempRoot = await fs.mkdtemp(path.join(os.tmpdir(), "forge-orchestrator-embedded-agent-"));
...
const ensureModels = (cfg: ForgeOrchestratorConfig) => ensureForgeOrchestratorModelsJson(cfg, agentDir) as unknown;
