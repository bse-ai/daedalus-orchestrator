...
describe("createForgeOrchestratorCodingTools", () => {
  ...
  it("gates apply_patch behind tools.exec.applyPatch for OpenAI models", () => {
    ...
    const openAiTools = createForgeOrchestratorCodingTools({
      config,
    ...
    const anthropicTools = createForgeOrchestratorCodingTools({
      config,
  ...
  it("respects apply_patch allowModels", () => {
    ...
    const allowed = createForgeOrchestratorCodingTools({
      config,
      modelProvider: "openai",
      modelId: "gpt-5.2",
    });
    ...
    const denied = createForgeOrchestratorCodingTools({
      config,
      modelProvider: "openai",
      modelId: "gpt-5-mini",
    });
