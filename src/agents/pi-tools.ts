...
import {
  ...
  CLAUDE_PARAM_GROUPS,
  createForgeOrchestratorReadTool,
...
function resolveExecConfig(cfg: ForgeOrchestratorConfig | undefined) {
...
export function createForgeOrchestratorCodingTools(options?: {
  ...
  const base = (codingTools as unknown as AnyAgentTool[]).flatMap((tool) => {
    if (tool.name === readTool.name) {
      ...
      return [createForgeOrchestratorReadTool(freshReadTool)];
    }
