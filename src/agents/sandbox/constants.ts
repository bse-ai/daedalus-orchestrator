...
export const DEFAULT_SANDBOX_BROWSER_IMAGE = "forge-orchestrator-sandbox-browser:bookworm-slim";
export const DEFAULT_SANDBOX_COMMON_IMAGE = "forge-orchestrator-sandbox-common:bookworm-slim";

export const DEFAULT_SANDBOX_BROWSER_PREFIX = "forge-orchestrator-sbx-browser-";
