...
const CLEANUP_STATE_KEY = Symbol.for("forge-orchestrator.sessionWriteLockCleanupState");
const HELD_LOCKS_KEY = Symbol.for("forge-orchestrator.sessionWriteLockHeldLocks");
