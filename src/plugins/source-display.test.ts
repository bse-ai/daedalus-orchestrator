...
describe("formatPluginSourceForTable", () => {
  it("shortens bundled plugin sources under the stock root", () => {
    const out = formatPluginSourceForTable(
      {
        origin: "bundled",
        source: "/opt/homebrew/lib/node_modules/forge-orchestrator/extensions/bluebubbles/index.ts",
      },
      {
        stock: "/opt/homebrew/lib/node_modules/forge-orchestrator/extensions",
        global: "/Users/x/.forge-orchestrator/extensions",
        workspace: "/Users/x/ws/.forge-orchestrator/extensions",
      },
    );
  ...
  it("shortens workspace plugin sources under the workspace root", () => {
    const out = formatPluginSourceForTable(
      {
        origin: "workspace",
        source: "/Users/x/ws/.forge-orchestrator/extensions/matrix/index.ts",
      },
      {
        stock: "/opt/homebrew/lib/node_modules/forge-orchestrator/extensions",
        global: "/Users/x/.forge-orchestrator/extensions",
  ...
  it("shortens global plugin sources under the global root", () => {
    const out = formatPluginSourceForTable(
      {
        origin: "global",
        source: "/Users/x/.forge-orchestrator/extensions/zalo/index.js",
      },
      {
        stock: "/opt/homebrew/lib/node_modules/forge-orchestrator/extensions",
        global: "/Users/x/.forge-orchestrator/extensions",
