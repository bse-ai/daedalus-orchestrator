...
function setDiscordDmPolicy(cfg: ForgeOrchestratorConfig, dmPolicy: DmPolicy) {
  const allowFrom =
...
function setDiscordAllowFrom(cfg: ForgeOrchestratorConfig, allowFrom: string[]): ForgeOrchestratorConfig {
  return {
    ...cfg,
    channels: {
      ...cfg.channels,
