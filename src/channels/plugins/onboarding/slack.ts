...
function setSlackDmPolicy(cfg: ForgeOrchestratorConfig, dmPolicy: DmPolicy) {
  const allowFrom =
...
function setSlackAllowFrom(cfg: ForgeOrchestratorConfig, allowFrom: string[]): ForgeOrchestratorConfig {
  return {
    ...cfg,
    channels: {
      ...cfg.channels,
