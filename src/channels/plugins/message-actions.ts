...
export function supportsChannelMessageButtons(cfg: ForgeOrchestratorConfig): boolean {
  for (const plugin of listChannelPlugins()) {
...
export function supportsChannelMessageCards(cfg: ForgeOrchestratorConfig): boolean {
  for (const plugin of listChannelPlugins()) {
