...
const ensureForgeOrchestratorModelsJson = vi.fn().mockResolvedValue(undefined);
const resolveForgeOrchestratorAgentDir = vi.fn().mockReturnValue("/tmp/forge-orchestrator-agent");
...
vi.mock("../config/config.js", () => ({
  ...
  STATE_DIR: "/tmp/forge-orchestrator-state",
  loadConfig,
}));

vi.mock("../agents/models-config.js", () => ({
  ensureForgeOrchestratorModelsJson,
}));

vi.mock("../agents/agent-paths.js", () => ({
  resolveForgeOrchestratorAgentDir,
}));
