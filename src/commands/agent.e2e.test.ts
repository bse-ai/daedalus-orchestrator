...
async function withTempHome<T>(fn: (home: string) => Promise<T>): Promise<T> {
  return withTempHomeBase(fn, { prefix: "forge-orchestrator-agent-" });
}

function mockConfig(
  home: string,
  storePath: string,
  agentOverrides?: Partial<NonNullable<NonNullable<ForgeOrchestratorConfig["agents"]>["defaults"]>>,
  telegramOverrides?: Partial<NonNullable<ForgeOrchestratorConfig["telegram"]>>,
