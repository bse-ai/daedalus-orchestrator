...
const debugAccounts = (...args: unknown[]) => {
  if (isTruthyEnvValue(process.env.FORGE_ORCH_DEBUG_TELEGRAM_ACCOUNTS)) {
...
function mergeTelegramAccountConfig(cfg: ForgeOrchestratorConfig, accountId: string): TelegramAccountConfig {
