...
import type { ForgeOrchestratorConfig, ReplyToMode, TelegramAccountConfig } from "../config/types.js";
...
async function resolveStickerVisionSupport(cfg: ForgeOrchestratorConfig, agentId: string) {
  try {
