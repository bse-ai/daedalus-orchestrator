import type { ForgeOrchestratorConfig } from "./config.js";
...
function isTelegramConfigured(cfg: ForgeOrchestratorConfig, env: NodeJS.ProcessEnv): boolean {
...
function isDiscordConfigured(cfg: ForgeOrchestratorConfig, env: NodeJS.ProcessEnv): boolean {
...
function isIrcConfigured(cfg: ForgeOrchestratorConfig, env: NodeJS.ProcessEnv): boolean {
...
function isSlackConfigured(cfg: ForgeOrchestratorConfig, env: NodeJS.ProcessEnv): boolean {
  if (
...
function isSignalConfigured(cfg: ForgeOrchestratorConfig): boolean {
...
function isIMessageConfigured(cfg: ForgeOrchestratorConfig): boolean {
...
function isPluginExplicitlyDisabled(cfg: ForgeOrchestratorConfig, pluginId: string): boolean {
...
function ensureAllowlisted(cfg: ForgeOrchestratorConfig, pluginId: string): ForgeOrchestratorConfig {
...
function registerPluginEntry(cfg: ForgeOrchestratorConfig, pluginId: string): ForgeOrchestratorConfig {
  const entries = {
    ...cfg.plugins?.entries,
    [pluginId]: {
