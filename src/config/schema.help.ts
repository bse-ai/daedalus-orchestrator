...
export const FIELD_HELP: Record<string, string> = {
  "meta.lastTouchedVersion": "Auto-set when ForgeOrchestrator writes the config.",
  ...
  "agents.defaults.memorySearch.store.path":
    "SQLite index path (default: ~/.forge-orchestrator/memory/{agentId}.sqlite).",
  ...
  "memory.backend": 'Memory backend ("builtin" for ForgeOrchestrator embeddings, "qmd" for QMD sidecar).',
