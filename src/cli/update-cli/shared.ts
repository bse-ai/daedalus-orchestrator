...
const FORGE_ORCH_REPO_URL = "https://github.com/forge-orchestrator/forge-orchestrator.git";
...
export function normalizeTag(value?: string | null): string | null {
  ...
  if (trimmed.startsWith("forge-orchestrator@")) {
    return trimmed.slice("forge-orchestrator@".length);
  }
