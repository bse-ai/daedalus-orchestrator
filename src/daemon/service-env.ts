...
export function buildServiceEnvironment(params: {
  ...
  const stateDir = env.FORGE_ORCH_STATE_DIR;
  const configPath = env.FORGE_ORCH_CONFIG_PATH;
  return {
    HOME: env.HOME,
    PATH: buildMinimalServicePath({ env }),
    FORGE_ORCH_PROFILE: profile,
    FORGE_ORCH_STATE_DIR: stateDir,
    FORGE_ORCH_CONFIG_PATH: configPath,
    FORGE_ORCH_GATEWAY_PORT: String(port),
    FORGE_ORCH_GATEWAY_TOKEN: token,
    FORGE_ORCH_LAUNCHD_LABEL: resolvedLaunchdLabel,
    FORGE_ORCH_SYSTEMD_UNIT: systemdUnit,
    FORGE_ORCH_SERVICE_MARKER: GATEWAY_SERVICE_MARKER,
    FORGE_ORCH_SERVICE_KIND: GATEWAY_SERVICE_KIND,
