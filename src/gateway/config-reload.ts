...
import type { ForgeOrchestratorConfig, ConfigFileSnapshot, GatewayReloadMode } from "../config/config.js";
...
export function startGatewayConfigReloader(opts: {
  ...
  onHotReload: (plan: GatewayReloadPlan, nextConfig: ForgeOrchestratorConfig) => Promise<void>;
  onRestart: (plan: GatewayReloadPlan, nextConfig: ForgeOrchestratorConfig) => void;
  log: {
