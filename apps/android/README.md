## ForgeOrchestrator Node (Android) (internal)

Modern Android node app: connects to the **Gateway WebSocket** (`_forge-orchestrator-gw._tcp`) and exposes **Canvas + Chat + Camera**.
