...
- `fix: <summary> (forge-orchestrator#<PR>) thanks @<author>`

```sh
commit_msg="fix: <summary> (forge-orchestrator#$pr_number) thanks @$contrib"
...
echo "$subject" | rg -q "forge-orchestrator#$pr_number" || { echo "ERROR: commit subject missing forge-orchestrator#$pr_number"; exit 1; }
