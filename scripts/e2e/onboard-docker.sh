...
TRASH
  ...
  send_skills_flow() {
    ...
    workspace_dir="$HOME/.forge-orchestrator/workspace"
    config_path="$HOME/.forge-orchestrator/forge-orchestrator.json"
    sessions_dir="$HOME/.forge-orchestrator/agents/main/sessions"
...
NODE
  ...
  run_case_reset() {
    ...
    # Seed a remote config to exercise reset path.
	    cat > "$HOME/.forge-orchestrator/forge-orchestrator.json" <<'"'"'JSON'"'"'
{
