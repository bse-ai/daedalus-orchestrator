...
if [[ -z "$version_content" ]]; then
  echo "<h2>ForgeOrchestrator $VERSION</h2>"
  echo "<p>Latest ForgeOrchestrator update.</p>"
  echo "<p><a href=\"https://github.com/forge-orchestrator/forge-orchestrator/blob/main/CHANGELOG.md\">View full changelog</a></p>"
  exit 0
fi
