...
INSTALL_URL="${FORGE_ORCH_INSTALL_URL:-https://forge-orchestrator.bot/install.sh}"
SMOKE_PREVIOUS_VERSION="${FORGE_ORCH_INSTALL_SMOKE_PREVIOUS:-}"
SKIP_PREVIOUS="${FORGE_ORCH_INSTALL_SMOKE_SKIP_PREVIOUS:-0}"
DEFAULT_PACKAGE="forge-orchestrator"
PACKAGE_NAME="${FORGE_ORCH_INSTALL_PACKAGE:-$DEFAULT_PACKAGE}"
...
if [[ -n "${FORGE_ORCH_INSTALL_LATEST_OUT:-}" ]]; then
  printf "%s" "$LATEST_VERSION" > "${FORGE_ORCH_INSTALL_LATEST_OUT:-}"
fi
