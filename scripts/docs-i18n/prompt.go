...
- Keep product names in English: ForgeOrchestrator, Pi, WhatsApp, Telegram, Discord, iMessage, Slack, Microsoft Teams, Google Chat, Signal.
- For the ForgeOrchestrator Gateway, use "Gateway 网关".
