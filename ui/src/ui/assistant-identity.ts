...
declare global {
  interface Window {
    __FORGE_ORCH_ASSISTANT_NAME__?: string;
    __FORGE_ORCH_ASSISTANT_AVATAR__?: string;
  }
}
...
export function resolveInjectedAssistantIdentity(): AssistantIdentity {
  ...
  return normalizeAssistantIdentity({
    name: window.__FORGE_ORCH_ASSISTANT_NAME__,
    avatar: window.__FORGE_ORCH_ASSISTANT_AVATAR__,
  });
}
